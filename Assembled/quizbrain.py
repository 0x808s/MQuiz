    ...
    class MaoriQuiz:
        ...
        def get_result(self):
            ...
            r_title = Label(r_frame, text="Final Results:",
                            font=("Arial", "16", "bold"))
            r_title.place(x=150, y=0)
            # Labels for displaying user score
            r_score = Label(r_frame, text=f"Score: {result}",
                            font=("Fixedsys", "17", "underline"))
            r_score.place(x=60, y=50)
            r_correct = Label(r_frame, text=correct,
                              font=("Fixedsys", "17", "underline"))
            r_correct.place(x=60, y=100)
            r_wrong = Label(r_frame, text=wrong,
                            font=("Fixedsys", "17", "underline"))
            r_wrong.place(x=60, y=150)
